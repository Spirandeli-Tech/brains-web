...
export function Sidebar() {
  ...
  return (
    <aside className="w-20 bg-white border-r border-gray-200 flex flex-col items-center py-4 fixed left-0 top-16 bottom-0 z-10">
        ...
        {NAV_OPTIONS.map((item) => {
          ...
          return (
            <button
              ...
              style={isActive ? { borderRight: '2px solid #2563eb', background: '#eff6ff' } : {}}
            >
